...
/**
 * dll_adj_swap - swaps tf a doubly linked list
 * @list:ist of integers to be sorted
...
/**
 * cocktail_sort_list - sorts a doust of integers in ascending
 * order using an cocktalgorithm
 * @list: doubly linked list of integers to 
 */
