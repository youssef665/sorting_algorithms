...
/**
 * maxHeapify - The main functionx Heap. The function
...
/**
 * heap_sort -  The ort an array of given size
 * @array: array to sort
...
void heap_sort(int *array, size_t size)
{
	int i;
	/**
	 * Start fromst and rightmost internal mode and heapify all
	...
	/**
	* Repeat ng steps while heap size is greater than 1.
